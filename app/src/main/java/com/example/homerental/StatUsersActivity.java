...
public class StatUsersActivity extends AppCompatActivity {
    PieChart pieChart;
    FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stat_users);
    ...
    private void updateChart(int blockedUsers, int nonBlockedUsers) {
        ...
        dataSet.setColors(new int[]{android.R.color.holo_red_dark, android.R.color.holo_blue_dark}, this);
